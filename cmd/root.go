...
func init() {
	...
	rootCmd.Flags().String("zcash-conf-path", "./zero.conf", "conf file to pull RPC creds from")
	...
	rootCmd.Flags().String("data-dir", "./", "data directory (such as db)")
	...
	viper.SetDefault("zcash-conf-path", "./zero.conf")
